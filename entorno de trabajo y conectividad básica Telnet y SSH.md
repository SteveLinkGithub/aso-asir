...
El objetivo de esta actividad es crear un entorno de trabajo con máquinas virtuales y comprobar en ese entorno la conectividad básica 
remota mediante Telnet y SSH. Este entorno de trabajo nos servirá para desarrollar el resto de actividades.
